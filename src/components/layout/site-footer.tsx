...
const LINKS = [
  {
    label: '提交新工具',
    href: 'https://github.com/Jlnvv-tom/awesome-ai-tools/issues/new?template=new-site.yml',
  },
  {
    label: '贡献指南',
  ...
  {
    label: '路线图',
    href: 'https://github.com/Jlnvv-tom/awesome-ai-tools/blob/master/ROADMAP.md',
  },
